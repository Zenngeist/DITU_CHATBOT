...
DATA_PATH = "/home/zengeist/Documents/university-chatbot/data"
...
def get_document_metadata(filename):
    ...
    This version uses a more robust, subject-first classification logic.
    """
    ...
    for filename in os.listdir(DATA_PATH):
        ...
        try:
            if filename.endswith('.pdf'): loader = PyMuPDFLoader(file_path)
                ...
                print(f"    > Skipping unsupported file: {filename}"); continue
...
if not all_documents:
    ...
    vector_store = Chroma(collection_name="final_retrieval_system", embedding_function=embedding_model, persist_directory=VECTOR_STORE_PATH)
    store = InMemoryStore()
